    ...
    def __init__(self, requests, cache, library, params):
        ...
        try:
            ...
            if "Failed to Connect" in str(e):
                raise Failed("Connector Error: The Sonarr URL specified could not be reached. Check Sonarr URL is correct and reachable") from e
            elif "401 [Unauthorized]" in str(e):
                raise Failed("Connector Error: The Sonarr token specified could not be validated. Please verify that the token is correct.") from e
            else:
